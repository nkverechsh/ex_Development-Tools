...
export default function game() {
  function Cards (card) {
    ...
    document.querySelector('.game-page__cards').insertAdjacentHTML('afterbegin', htmlCards)
    }
                ...
                <div class="game-page">
                    <div class="game-page__title">
                      <div class="game-page__timer">
                        <p class="game-page__timer-min">min</p>
                        <p class="game-page__timer-min_sec">sec</p>

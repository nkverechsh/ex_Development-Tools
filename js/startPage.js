...
function startPage() {
    ...
    const html = `
        ...
        <div class="complexity__level">
            <button class="complexity__level_variant eazy">1</button>
    ...
    document.querySelector('.complexity__level_variant eazy').addEventListener('click', () => saveLevel('eazy'))
    document.querySelector('.complexity__level_variant medium').addEventListener('click', () => saveLevel('medium'))
    document.querySelector('.complexity__level_variant hard').addEventListener('click', () => saveLevel('hard'))
    document.querySelector('.start__game').addEventListener('click', () => game())
}
